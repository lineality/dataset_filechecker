...
# =====================================================================
try:
    from rapidfuzz.distance import Levenshtein as _rapidfuzz_levenshtein_module
    RAPIDFUZZ_ACCELERATION_AVAILABLE: bool = True
except ImportError:
    _rapidfuzz_levenshtein_module = None
